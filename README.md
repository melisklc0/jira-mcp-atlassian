...
5. Run setup wizard:
   ...
   docker run --rm -i \
     ...
     ghcr.io/melisklc0/jira-mcp-atlassian:latest --oauth-setup -v
   ```
...
docker pull ghcr.io/melisklc0/jira-mcp-atlassian:latest
```
  ...
  "mcpServers": {
    "mcp-atlassian": {
      ...
      "args": [
        ...
        "-e", "JIRA_USERNAME",
        "-e", "JIRA_API_TOKEN",
        "ghcr.io/melisklc0/jira-mcp-atlassian:latest"
      ],
      "env": {
